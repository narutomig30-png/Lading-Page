...
- Abra seu navegador MySQL
- Crie um novo banco de dados com o nome `landing_page_db`.
- Selecione o banco de dados `landing_page_db` que você acabou de criar.
- Copie o código fornecido em schema.sql e cole no database `landing_page_db`.
...
7. Para verificar se os dados foram salvos, acesse o MySQL, selecione o banco `landing_page_db` e abra a tabela `clientes`. O novo registro deve estar lá.
